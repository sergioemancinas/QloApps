...
{*
 * FeWo Lauscha brand invoice palette — per docs/invoice-brand-rule.md
 * (design source: Lauscha Holiday Home Logo pack, Invoice.dc.html).
 * TCPDF-safe: literal hex only, helvetica stands in for Jost, times for Lora.
 *}
{assign var=color_header value="#17332B"}
{assign var=color_header_text value="#FAF8F4"}
{assign var=color_border value="#17332B"}
{assign var=color_border_lighter value="#DDD7CC"}
{assign var=color_line_even value="#FFFFFF"}
{assign var=color_line_odd value="#FAF8F4"}
{assign var=color_accent value="#2F5D4E"}
{assign var=color_muted value="#5C6F68"}
